...
void ssd1306_text(ssd1306_t *display, int x, int y, const char *text, bool wrap) {
  // Aqui você implementa o código necessário para exibir o texto na tela
  // Por exemplo:
  while (*text) {
      ssd1306_draw_char(display, *text++, x, y);
      x += 6; // Move a posição para o próximo caractere (ajuste conforme necessário)
  }
}
